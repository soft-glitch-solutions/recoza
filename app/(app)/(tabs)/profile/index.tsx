...
const styles = StyleSheet.create({
  ...
  avatar: { width: 96, height: 96, borderRadius: 48, justifyContent: 'center', alignItems: 'center', borderWidth: 4, borderColor: 'rgba(255,255,255,0.2)', backgroundColor: 'rgba(255,255,255,0.1)' },
  avatarText: { fontSize: 40, fontWeight: '900', color: '#fff' },
  collectorBadge: { position: 'absolute', bottom: 0, right: 0, width: 32, height: 32, borderRadius: 16, justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#fff' },
  userName: { fontSize: 28, fontWeight: '900', color: '#fff', letterSpacing: -0.5 },
  userEmail: { fontSize: 16, color: 'rgba(255,255,255,0.8)', marginTop: 4, fontWeight: '500' },
  statusPill: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, marginTop: 16 },
  statusText: { fontSize: 14, fontWeight: '700' },
  scrollView: { flex: 1 },
  contentContainer: { padding: 20 },
  statsGrid: { flexDirection: 'row', gap: 16, marginTop: -32, marginBottom: 32 },
  statsCard: { flex: 1, borderRadius: 16, padding: 20, alignItems: 'center', borderWidth: 1 },
  ...
  menuCard: { borderRadius: 16, overflow: 'hidden', borderWidth: 1, borderColor: '#E5E7EB' },
  ...
  logoutButton: { marginTop: 8, marginBottom: 24, borderRadius: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 12, paddingVertical: 20 },

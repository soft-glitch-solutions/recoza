...
const styles = StyleSheet.create({
  ...
  mainStatCard: { borderRadius: 24, padding: 20, flexDirection: 'row', alignItems: 'center', gap: 16, borderWidth: 3, borderColor: '#000000' },
  mainStatIcon: { width: 64, height: 64, borderRadius: 20, overflow: 'hidden', justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#000000' },
  ...
  ringOuter: { width: 100, height: 100, borderRadius: 50, borderWidth: 3, borderColor: '#000000', justifyContent: 'center', alignItems: 'center', position: 'relative' },
  ringInner: { width: 84, height: 84, borderRadius: 42, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#000000' },
  ...
  achievementCard: { borderRadius: 24, padding: 20, borderWidth: 3, borderColor: '#000000', marginBottom: 12 },
  achievementRow: { flexDirection: 'row', alignItems: 'center', gap: 16 },
  achievementIcon: { width: 56, height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#000000' },

            ...
            <View style={[
              ...
              <View style={[
                ...
                <TextInput
                  ...
                  editable={!isLoading}
                />
                <TouchableOpacity onPress={() => setConfirmPasswordVisible(!confirmPasswordVisible)} disabled={isLoading}>
              ...
              <Text style={[styles.termsText, { fontSize: isDesktop ? 13 : scale(13), color: colors.textSecondary }]}>
...
const styles = StyleSheet.create({
  ...
  termsText: { textAlign: 'center', marginBottom: isDesktop ? 24 : scale(20), lineHeight: 20 },
  termsLink: { fontWeight: '500' },
  registerButton: { justifyContent: 'center', alignItems: 'center' },
  registerButtonDisabled: { opacity: 0.7 },
  registerButtonText: { fontWeight: '600', color: '#ffffff' },
